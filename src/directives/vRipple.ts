...
export const vRipple: ObjectDirective = {
    beforeMount: (targetElement: HTMLElement, binding: DirectiveBinding<string | Record<string, string | number>>) => {
        // Default values.
        const props = {
            transition: 500,
        ...
        const clickRippler = (event: MouseEvent, targetElement: HTMLElement) => {
            ...
            const boundingRectangle = target.getBoundingClientRect(),
                ...
                rippleRadius = Math.sqrt(maxRippleWidth * maxRippleWidth + maxRippleHeight * maxRippleHeight),
